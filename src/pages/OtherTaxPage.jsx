...
const DEFS = [
  {
    ...
    body: `ប្រាក់រំដោះពន្ធលើប្រាក់ចំណេញ (PTOI) គឺជាការបង់ជាមុននូវពន្ធលើប្រាក់ចំណេញ
ដោយគណនាលើអត្រា 1% នៃផលរបរប្រចាំខែ។
• ប្រមូលជារៀងរាល់ខែ
• គណនាលើផលរបរ — មិនមែនប្រាក់ចំណេញទេ
• ពន្ធត្រូវបង់ − ប្រាក់រំដោះពន្ធបានបង់ = សមតុល្យពន្ធត្រូវបង់
• ប្រកាស និងបង់ពន្ធ: ផ្ទាល់ត្រឹមថ្ងៃទី 20 | E-Filing ត្រឹមថ្ងៃទី 20
• ទម្រង់: ព 01`,
  },
  {
...
ទំនិញ ឬសេវាក្នុងប្រទេស។

វិធីគណនា:
• ករណីរួមបញ្ចូល VAT: មូលដ្ឋានគិតពន្ធ = សរុប / 1.1
• ករណីមិនរួមបញ្ចូល VAT: មូលដ្ឋានគិតពន្ធ = សរុប
ប្រាក់រំដោះពន្ធ = មូលដ្ឋានគិតពន្ធ × 1%

ចំណាំ: ផលរបររួមបញ្ចូលអាករគ្រប់ប្រភេទ
លើកលែងតែអាករលើតម្លៃបន្ថែម (VAT) 10%`,
  },
  {
    term: "អ្នកមានកាតព្វកិច្ចបង់ប្រាក់រំដោះពន្ធ",
    color: "#92400E", bg: "#FFFBEB", border: "#FDE68A",
    body: `សហគ្រាសដែលត្រូវបង់ប្រាក់រំដោះពន្ធរួមមាន:
1. សហគ្រាសជាប់ពន្ធលើប្រាក់ចំណេញ (របបស្វ័យប្រកាស)
2. គម្រោងវិនិយោគមានលក្ខណៈសម្បត្តិគ្រប់គ្រាន់ (QIP) ដែលជាប់អត្រា 9% (ក្រោយរយៈពេលលើកលែងពន្ធ)
3. សហគ្រាសដែលចុះបញ្ជីអាករលើតម្លៃបន្ថែម (VAT)
...
• អង្គការក្រៅរដ្ឋាភិបាលដែលមិនរកប្រាក់ចំណេញ`,
  ...
  {
    term: "ការទូទាត់ជាមួយពន្ធប្រចាំឆ្នាំ",
    color: "#6B21A8", bg: "#FAF5FF", border: "#DDD6FE",
    body: `ប្រាក់រំដោះពន្ធត្រូវបានប្រើប្រាស់ជាឥណទានពន្ធ:

វិធីគណនា៖
• ពន្ធប្រចាំឆ្នាំ = ប្រាក់ចំណូលជាប់ពន្ធ × អត្រាពន្ធ
• ដក: ប្រាក់រំដោះពន្ធដែលបានបង់ក្នុងឆ្នាំ
• សមតុល្យ = ប្រាក់ត្រូវបង់បន្ត (ឬអាចស្នើសុំសងត្រឡប់)

ប្រសិនបើ ប្រាក់រំដោះពន្ធ > ពន្ធប្រចាំឆ្នាំ → ក្លាយជាឥណទានយោង
ប្រសិនបើ ប្រាក់រំដោះពន្ធ < ពន្ធប្រចាំឆ្នាំ → ត្រូវបង់សមតុល្យបន្ថែម
• ទម្រង់: TO1 (លិខិតប្រកាសពន្ធលើប្រាក់ចំណេញ) — ប្រចាំឆ្នាំ`,
  },
  {
    term: "ការប្រកាស និងការបង់ប្រាក់រំដោះពន្ធ",
    color: "#991B1B", bg: "#FEF2F2", border: "#FCA5A5",
    body: `កាលបរិច្ឆេទ:
• ថ្ងៃទី 01 ដល់ថ្ងៃទី 20 នៃខែបន្ទាប់
• ប្រកាសតាមទម្រង់ ព 01 ឬតាមរយៈ E-Filing

ពិន័យករណីខកខានការបង់ពន្ធ:
1. ពន្ធប្រក្រតី: 10% នៃប្រាក់ពន្ធត្រូវបង់
2. ការប្រាក់: 2% ក្នុងមួយខែ
3. ពិន័យបន្ថែម: ករណីគេចវេះពន្ធ

ច្បាប់យោង: ច្បាប់ស្តីពីសារពើពន្ធឆ្នាំ 1997 
និងប្រកាសលេខ 001, 506`,
  },
];
...
const INFO_CARDS = [
  { icon: "💰", bg: "#EFF6FF", title: "អត្រាប្រាក់រំដោះពន្ធ",            value: "1%",            note: "លើផលរបរប្រចាំខែ" },
  { icon: "📅", bg: "#F0FDF4", title: "ថ្ងៃបង់ប្រចាំខែ",      value: "ទី 01 – 20",       note: "ខែបន្ទាប់ (E-Filing ដូចគ្នា)" },
  { icon: "📋", bg: "#FFFBEB", title: "ទម្រង់",                value: "ព 01 / E-Filing",  note: "ប្រកាសប្រចាំខែ" },
  { icon: "🔄", bg: "#FAF5FF", title: "ប្រើដូចឥណទាន",        value: "ពន្ធប្រចាំឆ្នាំ",        note: "ទូទាត់ជាមួយពន្ធប្រចាំឆ្នាំ" },
  { icon: "🏢", bg: "#FEF2F2", title: "អ្នកជាប់កាតព្វកិច្ច",              value: "របបស្វ័យប្រកាស",       note: "រួមទាំង QIP ក្រោយរយៈពេលលើកលែងពន្ធ" },
];
    ...
    <>
      <div style={S.card}>
        ...
        <div style={S.row2}>
          ...
          <div style={S.field}>
            <label style={S.label}>តើផលរបររួមបញ្ចូល VAT 10% ដែរឬទេ?</label>
            <select style={S.select} value={includesVAT}
              onChange={e => { setIncludesVAT(e.target.value); setResult(null); }}>
              <option value="yes">បាទ/ចាស (រួមបញ្ចូល អ.ត.ប 10%)</option>
        ...
        <div style={S.note}>
          ...
          • ករណីរួមបញ្ចូល VAT: មូលដ្ឋានគិតពន្ធ = សរុប ÷ 1.1<br />
          • ប្រាក់រំដោះពន្ធ = មូលដ្ឋានគិតពន្ធ × <strong>1%</strong>
        </div>
      </div>
      ...
      {result && (
        <>
          <div style={S.metricGrid}>
            ...
            <div style={S.metric}>
              <div style={S.mLabel}>ប្រាក់រំដោះពន្ធ (1%)</div>
          ...
          <div style={S.card}>
            ...
            <table style={S.tbl}>
              ...
              <tbody>
                <tr>
                  <td style={S.td}>ផលរបរដែលបានបញ្ចូល</td>
                  <td style={{ ...S.td, color: "#2563EB", fontWeight: 700 }}>{fmt(result.originalAmount)}</td>
                </tr>
                {result.vatIncluded && (
                  <tr>
                    <td style={S.td}>− VAT 10% (÷ 1.1 ដើម្បីដកចេញ)</td>
            ...
            <div style={S.dedTotal}>
              <span>ប្រាក់រំដោះពន្ធ ({fmt(result.taxBase)} × 1%)</span>
            ...
            <div style={S.note}>
              ...
              • ប្រាក់រំដោះពន្ធ = {fmt(result.taxBase)} × 1% = <strong>{fmt(result.taxAmount)}</strong><br />
              → បង់ <strong>ថ្ងៃទី 01–20</strong> នៃខែបន្ទាប់ · ទម្រង់ ព 01 ឬ E-Filing
            </div>
          </div>
        </>
      )}
    ...
    <>
      <div style={S.card}>
        ...
        <div style={S.row2}>
          ...
          <div style={S.field}>
            <label style={S.label}>ប្រាក់រំដោះពន្ធសរុបដែលបានបង់ (1–12 ខែ) — ៛</label>
            <input style={S.input} type="number" placeholder="ឧ. 9000000"
              value={ptoiPaid} onChange={e => { setPtoiPaid(e.target.value); setResult(null); }} />
          </div>
        </div>
        <div style={S.note}>
          • សមតុល្យ = ពន្ធប្រចាំឆ្នាំ − ប្រាក់រំដោះពន្ធដែលបានបង់<br />
          • សមតុល្យ {">"} 0 → បង់សមតុល្យបន្ថែម (នៅពេលដាក់ប្រកាស TO1)<br />
          • សមតុល្យ {"<"} 0 → ក្លាយជាឥណទានយោង ឬស្នើសុំសងត្រឡប់
        </div>
      </div>
      ...
      {result && (
        <>
          <div style={S.metricGrid}>
            ...
            <div style={S.metric}>
              <div style={S.mLabel}>{result.due > 0 ? "សមតុល្យត្រូវបង់បន្ថែម" : "ឥណទាន / សងត្រឡប់"}</div>
          ...
          <div style={S.card}>
            ...
            {result.due > 0 ? (
              <div style={S.dedTotal}>
                <span>សមតុល្យត្រូវបង់បន្ថែម</span>
            ...
            <div style={result.due > 0 ? S.noteWarn : S.note}>
              ...
              {result.due > 0
                ? <>→ <strong>ត្រូវបង់សមតុល្យ {fmt(result.due)}</strong> ត្រឹមថ្ងៃទី 31/03 ឆ្នាំបន្ទាប់</>
                : <>→ <strong>ឥណទាន {fmt(result.creditCarry)}</strong> — អាចស្នើសុំសងត្រឡប់ ឬយោងទៅមុខ</>
              }
            </div>
          </div>
        </>
...
function RatesTab() {
  return (
    <>
      <div style={S.card}>
        <div style={S.cardTitle}>អត្រា និងបទប្បញ្ញត្តិ — ឯកសារយោង</div>
        <table style={S.tbl}>
          <thead>
            <tr>
          ...
          <tbody>
            {[
              ["ប្រាក់រំដោះពន្ធ (របបស្វ័យប្រកាស)",        "1%", "លើផលរបរដែលមិនរួមបញ្ចូល VAT ប្រចាំខែ"],
              ["QIP ក្រោយរយៈពេលលើកលែងពន្ធ",    "1%", "ជាប់អត្រា 9% → ជាប់ប្រាក់រំដោះពន្ធ 1% ផងដែរ"],
              ["QIP ក្នុងរយៈពេលលើកលែងពន្ធ",    "0%", "លើកលែងប្រាក់រំដោះពន្ធ"],
              ["សមតុល្យពន្ធប្រចាំឆ្នាំ",        "—",  "TO1 — ត្រូវប្រកាសត្រឹមថ្ងៃទី 31 មីនា"],
            ].map(([type, rate, note]) => (
              <tr key={type}>
                <td style={S.td}>{type}</td>
                <td style={{ ...S.td, fontWeight: 700, color: rate === "—" ? "#64748B" : rate === "0%" ? "#166534" : "#c0392b" }}>{rate}</td>
      ...
      <div style={S.card}>
        <div style={S.cardTitle}>ច្បាប់ និងបទប្បញ្ញត្តិយោង</div>
        <table style={S.tbl}>
          <thead><tr><th style={S.th}>ឯកសារ</th><th style={S.th}>ថ្ងៃខែឆ្នាំ</th><th style={S.th}>មាតិកា</th></tr></thead>
          <tbody>
            {[
              ["ច្បាប់ស្តីពីសារពើពន្ធ", "1997", "ក្របខ័ណ្ឌពន្ធលើប្រាក់ចំណេញ"],
              ["ប្រកាសលេខ 001 ប្រក.សហវ.ពដ", "02/01/2001", "ការគណនាប្រាក់រំដោះពន្ធ 1%"],
              ["ប្រកាសលេខ 506 សហវ.ពដ", "24/07/2002", "ការអនុគ្រោះពន្ធសម្រាប់ QIP"],
        ...
        <div style={S.note}>
          <strong>ការប្រកាស/បង់:</strong> ថ្ងៃទី 01 – <strong>ទី 20</strong> នៃខែបន្ទាប់ · ទម្រង់ ព 01 ឬ E-Filing<br />
          <strong>ពន្ធប្រក្រតី:</strong> 10% + ការប្រាក់ 2%/ខែ ក្នុងករណីបង់យឺតយ៉ាវ
        </div>
      </div>
    </>
  );
  ...
  return (
    <div style={S.page}>
      <div style={S.wrap}>
        ...
        <div style={S.header}>
          <div style={S.h1}>ប្រាក់រំដោះពន្ធលើប្រាក់ចំណេញ</div>
